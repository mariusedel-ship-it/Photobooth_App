        ...
        for (const param of Array.isArray(params) ? params : [params]) {
            ...
            for (const prop of param.get("properties")) {
                if (prop.isObjectProperty() &&
                    ...
                    this.attributeUtils.addExpressionAttribute(path, DATA_COLLECTION_ITEM_ID, this.types.identifier(prop.node.value.name));
                    return;
                }
            }
            const fieldToInject = idField ?? "id";
            param.node.properties.push(this.types.objectProperty(this.types.identifier(fieldToInject), this.types.identifier(fieldToInject), false, true));
